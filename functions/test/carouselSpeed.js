...
let POPULATE_URL = `http://127.0.0.1:5002/v1/admin/cache/populateSceneCache`;
if (TEST) {
  ...
  POPULATE_URL = `https://v1populatescenecache-4f33egefga-ew.a.run.app`;
}
const DEFAULT_TIMEOUT = 15000;
const NUKE = false;
describe("Image Gen", () => {
  // it("Populate the scene cache.", async function() {
  //   // eslint-disable-next-line no-invalid-this
  //   this.timeout(DEFAULT_TIMEOUT);
  //   const response = await chai
  //       .request(POPULATE_URL)
  //       .post("")// /v1/admin/ai/generateSceneImages")
  //       .set("API-KEY", process.env.ADMIN_API_KEY)
  //       .send({
  //         catalogueId: "47E2xaFuV0iRXzMJCzFK",
  //       });
